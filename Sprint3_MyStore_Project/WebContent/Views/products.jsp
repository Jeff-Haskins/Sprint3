					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<p class="card-text collapse" id="collapseContent1">Have a
								...
								GanedenBC30. This probiotic improves digestive and immune health
								to keep your canine happy and healthy. This single-source
								protein recipe is made without chicken, chicken fat, eggs, peas,
								pea fiber, white potato or tapioca, which cuts out a lot of
								potential allergens allowing your dog to get back to basics when
								it comes to nutrition.</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<p class="card-text collapse" id="collapseContent2">Real
								...
								ingredients enhanced with vitamins and minerals, they're rich in
								taste and healthy nutrition.</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
				...
				<div class="card h-100 item-card" id="product3">
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<!--Text-->
							<p class="card-text collapse" id="collapseContent3">Every dog
								deserves clean teeth! Grain-free and gluten-free dental chews
								are safely digestible, with no artificial colors, flavors or
								preservatives. The chews are two-sided, with a groove and
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<p class="card-text collapse" id="collapseContent4">The KONG
								...
								with an erratic bounce that is ideal for dogs that like to chew
								while also fulfilling a dog's need to play. Want to extend play
								time? Be sure to stuff with tempting bits of kibble and entice
								with a dash of peanut butter. Add to the funs by adding KONG
								Snacks and topping with KONG Easy Treat.</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<p class="card-text collapse" id="collapseContent5">The Star
								Wars Darth Vader Rope Dog Toy gets your pup excited to chase him
								across the galaxy during spirited games of fetch with a loud and
								exciting squeak. A black and silver braided rope provides a
								satisfying and beneficial texture to chew on.</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
			...
			<div class="col mb-4">
				<div class="card h-100 item-card" id="product6">
					...
					<div class="card-body">
						<div class="collapse-content">
							<!--Title-->
							<h4 class="card-title">Marvel Deadpool Rubber Dog Toy, Small</h4>
				...
				<div class="card h-100 item-card" id="product7">
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<!--Text-->
							<p class="card-text collapse" id="collapseContent7">Give your
								pet a pet bed designed with elegance, entirely made of durable
								wood construction with a beautiful dark brown finish. The
								elevated design provides good ventilation for your pet to enjoy
								a comfortable sleep. Easy to assemble. For dogs and cats up to
								44 lbs..</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<p class="card-text collapse" id="collapseContent9">Designed
								...
								fulfills your dog's natural instinct to have a den that they can
								call their own. It brilliantly solves the issue of where to
								store all of your dog's accessories. The optional closet is a
								versatile addition to your dog crate furniture and an incredibly
								practical solution for storing your dog's coat, treats, favorite
								toy and lead all in one handy place.</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<p class="card-text collapse" id="collapseContent11">The
								FURminator Undercoat deShedding Tool for dogs reduces loose hair
								from shedding up to 90% with regular use. The stainless steel
								deShedding edge reaches through topcoat to safely and easily
								remove loose hair and undercoat without damaging topcoat or
								cutting skin when used as directed. Use the FURejector button to
								release hair with ease, making deShedding easier than ever! The
								ergonomic handle provides you with comfort, while the curved
								edge conforms to your pet's natural build and shape for their
								comfort.</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
					...
					<div class="card-body">
						<div class="collapse-content">
							...
							<p class="card-text collapse" id="collapseContent15">Easy to
								...
								attractive and appears well made. Adjustable, side snap closures
								that make it easy to tailor its fit. Warm and water resistant.
								The straps that attach to the back legs hold the coat in place
								during walks. Great fit, easy on and off as well as the fleece
								lining. Bring it for your pet in Winter! Let her/him feels warm
								and comfy.</p>
							<a class="btn btn-primary red-text p-1 my-1 mr-0 mml-1 collapsed"
